...
export function ListaMediadores({ setPage }) {
  return (
    <Card style={{flexFlow: 'wrap'}}>
      <Card onClick={() => {setPage('overview-mediadores')}} className="mt-6 w-96" style={{cursor: 'pointer', display: 'inline-block', textAlign: 'center', height: '200px', width: '230px'}}>
        <CardBody>
      ...
      </Card><Card onClick={() => {setPage('overview-mediadores')}} className="mt-6 w-96" style={{cursor: 'pointer', display: 'inline-block', textAlign: 'center', height: '200px', width: '230px'}}>
      <CardBody>
        <img style={{display: 'inline'}} src="/img/andrea-lista.png" alt=""/>
        <div>
          <Typography
